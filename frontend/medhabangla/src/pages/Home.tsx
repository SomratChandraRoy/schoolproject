      ...
      <div className="container mx-auto px-4 py-16">
        {/* <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            বাংলাদেশি শিক্ষার্থীদের জন্য একটি বিশেষভাবে ডিজাইন করা শিক্ষামূলক
            প্ল্যাটফর্ম
          </p>
          <p className="text-lg text-gray-500 dark:text-gray-400 mt-4">
            An AI-Powered Educational Platform for Bangladeshi Students (Class
            6-12)
          </p>
        </div> */}

        {/* Hero Image Banner - Full Size */}
        <div className="-mx-4 mb-16 w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
          <img
            src="/hero.png"
            alt="SOPAN Learning Platform"
            className="w-full h-auto object-cover dark:opacity-90 transition-opacity duration-300 hover:opacity-100"
          />
        </div>
