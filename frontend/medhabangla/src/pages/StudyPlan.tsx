...
const StudyPlan: React.FC = () => {
    ...
    const generatePlan = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const res = await axios.post('/api/academics/study-plans/generate_plan/', {
        ...
        <div className="max-w-7xl mx-auto p-6 md:flex gap-6 min-h-[80vh]">
            <div className="md:w-1/3 mb-6 md:mb-0 space-y-6">
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                    <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Generate AI Plan</h2>
                    <textarea 
                ...
                <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                    <h3 className="font-bold text-gray-700 dark:text-gray-300 mb-3">My Saved Plans</h3>
                    {plans.length === 0 ? (
            ...
            <div className="md:w-2/3 bg-white dark:bg-gray-800 p-6 md:p-8 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-y-auto max-h-[85vh]">
                {selectedPlan ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-gray-400">
                        ...
                        <p className="text-lg">Select a plan from the left or generate a new one.</p>
                    </div>
                )}
            </div>
        </div>
