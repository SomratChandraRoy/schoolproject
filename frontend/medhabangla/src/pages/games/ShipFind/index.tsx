    ...
    const handleGameComplete = async (
        ...
        try {
            const result = await gameService.submitScore({
                ...
                success: success,
                accuracy: success ? ((clicks / (clicks + 1)) * 100) : 0,
                metadata: {
                    clicks: clicks,
                    game_type: 'ship_find',
                },
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-8">
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <p className="text-lg opacity-90">Find all the hidden ships on the grid!</p>
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                {!isPlaying ? (
                    <div className="bg-white dark:bg-gray-800 rounded-lg p-12 text-center shadow-lg">
                        ...
                        <p className="text-lg mb-8 text-gray-700 dark:text-gray-300">
                            Current Level: <span className="font-bold text-blue-600 dark:text-blue-400">{gameSession.current_level}</span>
                        </p>
                        <button
                ...
                <div className="mt-8 bg-white dark:bg-gray-800 rounded-lg p-6 shadow">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 text-gray-700 dark:text-gray-300">
                        <div>
                            <h4 className="font-semibold mb-2 text-blue-600 dark:text-blue-400">Objective:</h4>
                        ...
                        <div>
                            <h4 className="font-semibold mb-2 text-purple-600 dark:text-purple-400">Symbols:</h4>
                            <ul className="space-y-1 text-sm">
