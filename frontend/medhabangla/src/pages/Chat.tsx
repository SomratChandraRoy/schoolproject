            ...
            <div className="w-1/3 border-r border-gray-200 dark:border-gray-700 flex flex-col bg-gray-50 dark:bg-gray-800">
              ...
              {searchResults.length > 0 && (
                <div className="p-2 border-b border-gray-200 dark:border-gray-700 max-h-64 overflow-y-auto custom-scrollbar bg-white dark:bg-gray-800">
                  <p className="text-sm text-gray-500 dark:text-gray-400 px-3 mb-2 font-medium">
                    Search Results:
                  </p>
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar">
                {chatRooms.length === 0 ? (
                  <div className="p-8 text-center text-gray-500 dark:text-gray-400">
                    ...
                    <p className="text-sm">
                      Search for members to start chatting
                    </p>
                  </div>
                ) : (
                  chatRooms.map((room) => (
                      ...
                      <div className="flex items-center gap-3">
                        <div className="relative">
                          <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white font-bold text-lg shadow-md">
                            {selectedRoom.other_participant.first_name?.[0] ||
                  ...
                  <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className={`px-6 py-3 rounded-xl text-white font-medium transition-all active-press ${
                ...
                <div className="flex-1 flex items-center justify-center bg-gray-50 dark:bg-gray-900">
                  <div className="text-center">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
                      Welcome to SOPAN Chat
                    </h3>
                    <p className="text-gray-500 dark:text-gray-400 max-w-md">
                      Select a chat from the sidebar or search for members to
