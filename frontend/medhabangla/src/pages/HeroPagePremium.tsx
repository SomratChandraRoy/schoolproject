...
const HeroPagePremium: React.FC = () => {
    ...
    const handleScroll = () => {
      ...
      if (featuresSection && philosophySection) {
        ...
        if (philosophyRect.top < window.innerHeight / 2) {
          setBgColor("#002a18");
          document.documentElement.style.setProperty("--text-color", "#f9f9f7");
        } else if (featuresRect.top < window.innerHeight / 2) {
          setBgColor("#eeeeec");
          document.documentElement.style.setProperty("--text-color", "#1a1c1b");
        } else {
          setBgColor("#f9f9f7");
          document.documentElement.style.setProperty("--text-color", "#1a1c1b");
        }
...
export default HeroPagePremium;
