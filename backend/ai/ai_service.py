    ...
    def get_provider_settings(self):
        ...
        try:
            ...
            return {
                ...
                'voice_stt_provider': settings_obj.voice_stt_provider,
                'voice_llm_provider': settings_obj.voice_llm_provider,
                'voice_tts_provider': settings_obj.voice_tts_provider,
                'voice_stt_provider_order': settings_obj.voice_stt_provider_order,
                'voice_llm_provider_order': settings_obj.voice_llm_provider_order,
                'voice_tts_provider_order': settings_obj.voice_tts_provider_order,
                ...
                'deepgram_stt_url': settings_obj.deepgram_stt_url,
                'deepgram_stt_language': settings_obj.deepgram_stt_language,
                'deepgram_stt_model': settings_obj.deepgram_stt_model,
                'deepgram_stt_tier': settings_obj.deepgram_stt_tier,
                'sarvam_stt_url': settings_obj.sarvam_stt_url,
                'sarvam_stt_language': settings_obj.sarvam_stt_language,
                'sarvam_tts_url': settings_obj.sarvam_tts_url,
                'sarvam_tts_language': settings_obj.sarvam_tts_language,
                'sarvam_tts_speaker': settings_obj.sarvam_tts_speaker,
                'gemini_tts_url': settings_obj.gemini_tts_url,
                'gemini_tts_voice': settings_obj.gemini_tts_voice,
                'study_plan_provider': settings_obj.study_plan_provider,
                'srijonshil_provider': settings_obj.srijonshil_provider,
                ...
                'deepgram_api_key': settings_obj.deepgram_api_key,
                'sarvam_api_key': settings_obj.sarvam_api_key,
            ...
            return {
                ...
                'voice_llm_provider': 'auto',
                'voice_tts_provider': 'auto',
                'voice_stt_provider_order': 'deepgram,sarvam',
                'voice_llm_provider_order': 'groq,alibaba',
                'voice_tts_provider_order': 'sarvam,gemini',
                'voice_fast_mode': True,
                'voice_force_bangla': True,
                'voice_response_max_chars': 520,
                ...
                'deepgram_stt_language': os.getenv('DEEPGRAM_STT_LANGUAGE', 'bn'),
                'deepgram_stt_model': os.getenv('DEEPGRAM_STT_MODEL', 'general'),
                'deepgram_stt_tier': os.getenv('DEEPGRAM_STT_TIER', 'nova-3'),
                'sarvam_stt_url': os.getenv('SARVAM_STT_URL', 'https://api.sarvam.ai/speech-to-text'),
                'sarvam_stt_language': os.getenv('SARVAM_STT_LANGUAGE', 'bn-IN'),
                'sarvam_tts_url': os.getenv('SARVAM_TTS_URL', 'https://api.sarvam.ai/text-to-speech'),
                'sarvam_tts_language': os.getenv('SARVAM_TTS_LANGUAGE', 'bn-IN'),
                'sarvam_tts_speaker': os.getenv('SARVAM_TTS_SPEAKER', 'anushka'),
                'gemini_tts_url': os.getenv('GEMINI_TTS_URL', 'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-preview-tts:generateContent'),
                'gemini_tts_voice': os.getenv('GEMINI_TTS_VOICE', 'Kore'),
                'srijonshil_provider': 'auto',
